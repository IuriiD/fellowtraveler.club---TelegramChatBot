L10N = {
    ...
    'message19': {
        ...
        'ru': 'Как я уже, наверное, говорил, моя мечта - увидеть мир.'
             ...
             'Пожалуйста, регистрируйте где я бываю, используя кнопку "<b>Добавить местоположение</b>".'
    ...
    'message60': {
        'en': 'To proceed please <b>enter the secret code</b> from the toy',
        'ru': 'Чтобы продолжить, пожалуйста, <b>введите секретный код</b> с игрушки',
        'uk': 'Щоб продовжити, будь ласка, <b>введіть секретний код</b> з іграшки'
    },
    'message61': {
    ...
    'message63': {
        ...
        'ru': '">Черкассы</a>, Украина, из семьи с тремя маленькими веселыми детьми',
        'uk': '">Черкаси</a>, Україна, із сім\'ї з трьома маленькими веселими дітьми'
    },
    'message64': {
